...
#. Edit the release on GitHub (e.g. https://github.com/gfdunn2/cookiecutter/releases). Paste the release notes into the release's release page, and come up with a title for the release.
